export const hobbiesListQuestions = [

    {
        ask: "Qual desses é considerado um hobby de coleta?",
        options: [
            "Leitura",
            "Fotografia",
            "Colecionar selos",
    ...
    {
        ask: "Qual hobby é frequentemente associado à criatividade e à expressão artística?",
        options: [
            "Jardinagem",
            "Pintura",
            "Ciclismo",
    ...
    {
        ask: "Qual destes é um hobby que pode ajudar na forma física?",
        options: [
            "Leitura",
            "Yoga",
            "Programação",
    ...
    {
        ask: "Qual atividade é considerada um hobby popular ao ar livre?",
        options: [
            "Assistir filmes",
            "Caminhadas",
            "Pintura",
    ...
    {
        ask: "Qual destes hobbies envolve a criação de conteúdo digital?",
        options: [
            "Fotografia",
    ...
    {
        ask: "Qual hobby pode ser praticado em grupo e é popular em festas?",
        options: [
            "Cozinhar",
            "Dança",
            "Ciclismo",
    ...
    {
        ask: "Qual desses hobbies é frequentemente associado ao relaxamento e à meditação?",
        options: [
            "Cozinhar",
            "Yoga",
            "Leitura",
    ...
    {
        ask: "Qual destes é um hobby que pode ser realizado em casa e envolve a manipulação de materiais?",
        options: [
            "Jardinagem",
            "Cozinhar",
            "Pintura",
    ...
    {
        ask: "Qual destes hobbies é frequentemente associado à tecnologia?",
        options: [
            "Programação",
            "Leitura",
            "Caminhadas",
    ...
    {
        ask: "Qual desses hobbies envolve habilidades manuais e criação de itens?",
        options: [
            "Jardinagem",
            "Fotografia",
            "Escrita",
